...
package android.support.lewa.view;
...
import android.support.lewa.os.ParcelableCompat;
import android.support.lewa.os.ParcelableCompatCreatorCallbacks;
import android.support.lewa.widget.EdgeEffectCompat;
 ...
 */
public class LewaPagerView extends ViewGroup {
    ...
    public LewaPagerView(Context context) {
        super(context);
        initViewPager();
    }

    public LewaPagerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
