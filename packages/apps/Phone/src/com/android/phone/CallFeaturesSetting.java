...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private static final String BUTTON_RECORDING    	 = "button_recording";
    private CheckBoxPreference mButtonRecording;
    static boolean mRecording;
    
    private static final String BUTTON_CLOSED    	 = "button_closed";
    private CheckBoxPreference mButtonClosed;
    static boolean mClosed ;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // Begin, Added to fix bug #2378, 20111210
        if (data == null) {
            return;
        }
        // End
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mButtonRecording = (CheckBoxPreference) prefSet.findPreference(BUTTON_RECORDING);
        mButtonRecording.setChecked(mRecording);
        
        mButtonClosed = (CheckBoxPreference) prefSet.findPreference(BUTTON_CLOSED);
        mButtonClosed.setChecked(mClosed);
        /*
        ...
        */
        ...
        {
        	 ((PreferenceCategory) prefSet.findPreference(CATEGORY_ADVANCED)).removePreference(mButtonClosed);
        }
        // No reason to show Trackball Answer & Hangup if it doesn't have a
        // Trackball.
        //Begin modifyed by panqianbo for bug #3561
    ...
    private void init(Context context, SharedPreferences pref) {
        ...
        mRecording = pref.getBoolean(BUTTON_RECORDING, false);
        mClosed = pref.getBoolean(BUTTON_CLOSED, true);
        mAlwaysProximity = pref.getBoolean(BUTTON_ALWAYS_PROXIMITY, false);
        mReturnHome = pref.getBoolean(BUTTON_RETURN_HOME, false);
    ...
    protected void onStop() {
        ...
        outState.putBoolean(BUTTON_RECORDING, mButtonRecording.isChecked());
        outState.putBoolean(BUTTON_CLOSED, mButtonClosed.isChecked());
