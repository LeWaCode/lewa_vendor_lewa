...
public class SimContacts extends ADNList {
    ...
    private static boolean parentViewAlive = false;
    private ProgressDialog mProgressDialog;
    ImportAllSimContactsThread thread;
	
    private Account mAccount;
    //Begin added by panqianbo for import contacts 
    private int mCount;
    //End
    ...
    private class ImportAllSimContactsThread extends Thread
        ...
        public void run() {
	     ...
	     int mCursorCount =mCursor.getCount();
            //End
	     //add by zenghuaying fix bug #12210
	     int pos = 0;
	     //add end
            while (!mCanceled && mCursor.moveToPosition(pos) && mCount < mCursorCount ) {
    ...
    private void importOneSimContact(int position) {
        ...
        if (mCursor.moveToPosition(position)) {
            actuallyImportOneSimContact(mCursor, resolver, mAccount);
            //Begin added by panqianbo for import contacts 
            Toast.makeText(this, getString(R.string.import_contact_count, 1), 500).show();
            //End
        } else {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        //Begin added by panqianbo for import contact
        mCount = 0;
	 parentViewAlive = true;
        //End
    }
	...
	protected void onDestroy() {
		...
		super.onDestroy();
		parentViewAlive = false;
		if(mCount > 0) {
			Toast.makeText(this, getString(R.string.import_contact_count, mCount), 500).show();
		}
	}
