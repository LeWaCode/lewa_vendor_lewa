...
public class Settings extends PreferenceActivity implements DialogInterface.OnClickListener,
    ...
    //UI objects
    ListPreference mClickedButtonPreferredNetworkMode;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        isTdNetwork = Boolean.parseBoolean(SystemProperties.get("ro.product.td-network"));
        ...
        if (getResources().getBoolean(R.bool.world_phone) == true) {
            ...
            if (isTdNetwork) {
                mButtonPreferredUmtsNetworkMode.setEntries(R.array.preferred_network_mode_choices_for_td);                    
            }
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        if (preference == mButtonPreferredNetworkMode ||
            ...
            mClickedButtonPreferredNetworkMode = (ListPreference)preference;
            int currPrefMode = Integer.valueOf(
                mClickedButtonPreferredNetworkMode.getValue()).intValue();
            int selPrefMode = Integer.valueOf((String) objValue).intValue();

            log("onPreferenceChange value=" + selPrefMode);
            
            // if select WCDMA only.  RILConstants.NETWORK_MODE_WCDMA_ONLY
            if (selPrefMode != currPrefMode && selPrefMode == 2) {
                new AlertDialog.Builder(this).setMessage(
                    getResources().getString(R.string.dialog_select_3gmode_alert))
                    .setTitle(R.string.dialog_select_3gmode_title)
                    .setIcon(android.R.drawable.ic_dialog_alert)
                    .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            setPreferenedNetworkMode(mClickedButtonPreferredNetworkMode.getValue());
                        }
                     })
                    .setNegativeButton(android.R.string.no, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            mClickedButtonPreferredNetworkMode.setValue(Integer.toString(settingsNetworkMode));
                            dialog.dismiss();
                        }
                     })
                    .show();
        ...
        if (preference == mButtonPreferredNetworkMode ||
                preference == mButtonPreferredUmtsNetworkMode ||
                preference == mButtonPreferredCdmaNetworkMode) {
            setPreferenedNetworkMode(objValue);
        }
    ...
    void setPreferenedNetworkMode(Object objValue) {
    ...
    private void UpdatePreferredNetworkModeSummary(int NetworkMode) {
        int phoneType = mPhone.getPhoneType();
        String prefMode = getResources().getString(R.string.preferred_network_mode_dialogtitle);
        String[] modeStr = getResources().getStringArray(R.array.network_preferences_choices);
        // TODO T: Make all of these strings come from res/values/strings.xml.
        if (phoneType == Phone.PHONE_TYPE_CDMA) {
            switch(NetworkMode) {
            case Phone.NT_MODE_EVDO_NO_CDMA:
                mButtonPreferredCdmaNetworkMode.setSummary(prefMode + modeStr[2]);
                break;                
            case Phone.NT_MODE_CDMA_NO_EVDO:
                mButtonPreferredCdmaNetworkMode.setSummary(prefMode + modeStr[1]);
                break;
            case Phone.NT_MODE_CDMA:
            default:
                mButtonPreferredCdmaNetworkMode.setSummary(prefMode + modeStr[0]);
            }
        } else if (phoneType == Phone.PHONE_TYPE_GSM) {            
            switch(NetworkMode) {
            case Phone.NT_MODE_WCDMA_PREF:
                mButtonPreferredUmtsNetworkMode.setSummary(prefMode + modeStr[0]);
                break;
            case Phone.NT_MODE_GSM_ONLY:
                mButtonPreferredUmtsNetworkMode.setSummary(prefMode + modeStr[1]);
                break;
            case Phone.NT_MODE_WCDMA_ONLY:
                mButtonPreferredUmtsNetworkMode.setSummary(prefMode + modeStr[2]);
                break;                
            case Phone.NT_MODE_GSM_UMTS:
            default:
                mButtonPreferredUmtsNetworkMode.setSummary(prefMode + modeStr[0]);
            ...
            modeStr = getResources().getStringArray(isTdNetwork ? 
                R.array.preferred_network_mode_choices_for_td : R.array.preferred_network_mode_choices);
            switch(NetworkMode) {
            case Phone.NT_MODE_WCDMA_PREF:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[7]);
                break;
            case Phone.NT_MODE_GSM_ONLY:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[6]);
                break;
            case Phone.NT_MODE_WCDMA_ONLY:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[5]);
                break;
            case Phone.NT_MODE_GSM_UMTS:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[4]);
                break;
            case Phone.NT_MODE_CDMA:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[3]);
                break;
            case Phone.NT_MODE_CDMA_NO_EVDO:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[2]);
                break;
            case Phone.NT_MODE_EVDO_NO_CDMA:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[1]);
                break;
            case Phone.NT_MODE_GLOBAL:
            default:
                mButtonPreferredNetworkMode.setSummary(prefMode + modeStr[0]);
            }
        }
    }
