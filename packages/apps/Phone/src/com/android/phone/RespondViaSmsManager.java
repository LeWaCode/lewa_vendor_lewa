...
public class RespondViaSmsManager {
    ...
    public void showRespondViaSmsPopup(Call ringingCall) {
        ...
        ArrayAdapter<String> adapter =new ArrayAdapter<String>(mInCallScreen,
                                         R.layout.sms_item,
                                         android.R.id.text1,
                                         popupItems);
    ...
    private void sendText(String phoneNumber, String message) {
        ...
        Uri uri = Uri.fromParts(SCHEME_SMSTO, phoneNumber, null);
...
//    private void sendText(String phoneNumber,String message) {
//    	Log.e("Main", "phoneNumber:"+phoneNumber+" message:"+message);
//    	
//    	if ( null != phoneNumber && !"".equals(phoneNumber.trim()) && null != message && !"".equals(message.trim()))
//    	{
...
//	}
    ...
    private void launchSmsCompose(String phoneNumber) {
        ...
        Uri uri = Uri.fromParts(SCHEME_SMS, phoneNumber, null);
