...
public class VerticalSeekBar extends AbsSeekBar {
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //width = 40;
        //height = 320;
        height = this.getResources().getDimensionPixelSize(R.dimen.eq_vertical_seekbar_width);
        width = this.getResources().getDimensionPixelSize(R.dimen.eq_vertical_seekbar_height);
