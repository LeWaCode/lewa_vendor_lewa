...
public class AllTrackBrowserAdapter extends SimpleCursorAdapter{
    ...
    private AllTrackBrowserActivity mActivity = null;
...
//            mSortKey = MusicUtils.storeSortKey(cursor, mSortKeyIdx);
	...
	public AllTrackBrowserAdapter(Context context, AllTrackBrowserActivity currentactivity,
	...
	public void setActivity(AllTrackBrowserActivity newactivity) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        vh.title = (TextView)view.findViewById(R.id.line1_title);
        vh.artistAlbum = (TextView)view.findViewById(R.id.line2_info);
        vh.duration = (TextView)view.findViewById(R.id.line1_duration);
...
//            return;
//        
//        vh.currentSortKey = cursor.getString(mSortKeyIdx).substring(0, 1);
//        int position = cursor.getPosition();  
    ...
    public void changeCursor(Cursor cursor) {
        ...
        if (cursor != mActivity.getTrackCursor()) {
