...
/*        public static final String SPECIAL_PHONE = "special_phone";*/
    ...
    public boolean onCreate() {
	  ...
	  Cursor cursor = db.query("location", new String[] {Columns.AREACODE}, "number = 1300000", null, null, null, null);
        if (cursor != null)
            cursor.close();
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case CARDTYPE:
                table = "cardType";
                selection = "cardTypeId in (select cardTypeId from location where " + selection + ")"; 
                break;
            case AREACODE:
                table = "areacode";
                break;
