...
class ItemInfo {
	...
	void assignFrom(ItemInfo info) {
		...
		//Begin [pan] add
        iconBackground = info.iconBackground;
        isInstallFlag = info.isInstallFlag;
        //End
		isUserInstalled = info.isUserInstalled;
	}
	...
	void onAddToDatabase(ContentValues values) {
        ...
        //Begin [pan] add
        values.put(LauncherSettings.Favorites.ICON_BACKGROUND, iconBackground);
        values.put(LauncherSettings.Favorites.DISPLAY_MODE, isInstallFlag);
        //End
	}
