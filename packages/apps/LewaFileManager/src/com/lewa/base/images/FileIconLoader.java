    ...
    private class LoaderThread extends HandlerThread implements Callback {
        ...
        public boolean handleMessage(Message msg) {
            ...
            while (iterator.hasNext()) {
                ...
                Logs.i("-----> ||| " + holder + " " + (holder != null ? holder.state : "-1"));
                    ...
                    switch (id.mCategory) {
                        ...
                        case Video:
                            ...
                            if (id.mId == 0) {
                                ...
                                if (id.mId != 0) {
                                    Bitmap bitmap = isVideo ? getVideoThumbnail(id.mId) : getImageThumbnail(id.mId);
                                    if (bitmap != null) {
                                        holder.setImage(bitmap);
                                    }
                                } else if (!isVideo) {
                                    Bitmap image = Utillocal.getImage(id.mPath, null, mContext);
                                    if (image != null) {
