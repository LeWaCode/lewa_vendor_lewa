 ...
 */
public class TextIndexer extends DataSetObserver implements SectionIndexer {
     ...
     */
    public TextIndexer(Cursor cursor, int sortedColumnIndex, Object[] text) {
        mDataCursor = cursor;
        mColumnIndex = sortedColumnIndex;
        mText = text;
        mAlphabetLength = text.length;
        mAlphabetArray = new String[mAlphabetLength];
        for (int i = 0; i < mAlphabetLength; i++) {
            mAlphabetArray[i] = mText[i].toString();
        }
    ...
    public int getPositionForSection(int sectionIndex) {
        ...
        char letter = mText[sectionIndex].toString().charAt(0);
        ...
        if (sectionIndex > 0) {
            int prevLetter =
                    mText[sectionIndex - 1].toString().charAt(0);
    ...
    public int getSectionForPosition(int position) {
        ...
        for (int i = 0; i < mAlphabetLength; i++) {
            char letter = mText[i].toString().charAt(0);
            String targetLetter = Character.toString(letter);
