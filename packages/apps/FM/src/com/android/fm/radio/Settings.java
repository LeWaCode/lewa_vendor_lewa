    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (mRxMode) {
            ...
            if (FMRadio.RECORDING_ENABLE) {
                ...
                mRecordDurPreference
                        .setEntries(R.array.record_durations_entries);
                mRecordDurPreference
                        .setEntryValues(R.array.record_duration_values);
                ...
                Log.d(LOGTAG,
                        "createPreferenceHierarchy: recordDurationSummary: "
        ...
        if (context.getResources().getBoolean(R.bool.require_bt)) {
            ...
            mBluetoothBehaviour
                    .setEntryValues(R.array.bt_exit_behaviour_values);
            mBluetoothBehaviour
                    .setDialogTitle(R.string.pref_bt_behaviour_on_exit_dialog_title);
            mBluetoothBehaviour.setKey(BT_EXIT_BEHAVIOUR);
            mBluetoothBehaviour
                    .setTitle(R.string.pref_bt_behaviour_on_exit_title);
            mBluetoothBehaviour
                    .setSummary(R.string.pref_bt_behaviour_on_exit_summary);
            ...
            mRemoveHeadset.setChecked(FmSharedPreferences
                    .getHeadsetDcBehaviour());
            ...
            if (mRxMode) {
                if (key.equals(AUTO_AF)) {
                    ...
                    if (FMRadio.RECORDING_ENABLE) {
                        ...
                        int index = 0;
                        if (valueStr != null) {
                            index = mRecordDurPreference
                                    .findIndexOfValue(valueStr);
                        }
                    ...
                    String[] btChoices = getResources().getStringArray(
                            R.array.bt_exit_behaviour_entries);
                    String valueStr = mBluetoothBehaviour.getValue();
                    Log.d(LOGTAG,
                            "onSharedPreferenceChanged: BT behaviour: "
                                    + btChoices[mBluetoothBehaviour
                                            .findIndexOfValue(valueStr)]);
                    FmSharedPreferences.setBluetoothExitBehaviour(Integer
                            .parseInt(valueStr));
                } else if (key.equals(HEADSET_DC_BEHAVIOUR)) {
                    boolean bRemoveHeadset = mRemoveHeadset.isChecked();
                    Log.d(LOGTAG,
                            "onSharedPreferenceChanged: Remove Headset Enable: "
                                    + bRemoveHeadset);
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case RESTORE_FACTORY_DEFAULT_INT:
            return new AlertDialog.Builder(this)
                    ...
                    .setTitle(R.string.settings_revert_confirm_title)
                    .setMessage(R.string.settings_revert_confirm_msg)
