...
public class PresetList {
    ...
    public synchronized void setStationFreq(int stationNum, int freq) {
        PresetStation mStation = mPresetList.get(stationNum);
        mStation.setFrequency(freq);
    }

    public synchronized int getIndexFromStation(PresetStation station) {
            ...
            for (int presetNum = 0; presetNum < totalPresets; presetNum++) {
                ...
                if (station != null) {
                    if (selectStation.getFrequency() == station.getFrequency()) {
                        if (selectStation.getName().equalsIgnoreCase(
                                station.getName())) {
