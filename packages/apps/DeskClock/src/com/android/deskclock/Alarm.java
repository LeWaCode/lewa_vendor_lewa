...
public final class Alarm implements Parcelable {
    ...
    public String getLabelOrDefault(Context context) {
     ...
     // add for easter eggs on 11.2
        Calendar curDate = Calendar.getInstance();
        curDate.setTimeInMillis(System.currentTimeMillis());
        
        Log.e("month="+curDate.get(Calendar.MONTH)+" date="+curDate.get(Calendar.DAY_OF_MONTH));
        if(curDate.get(Calendar.MONTH) == 10 && curDate.get(Calendar.DAY_OF_MONTH) == 2){
            return context.getString(R.string.easter_eggs_string);
        }
        //end
