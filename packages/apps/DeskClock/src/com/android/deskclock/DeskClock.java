...
//    private final int SCREEN_SAVER_COLOR_DIM = 0xFF004880;
    ...
    private void initViews() {
        ...
        galleryButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) { 
            	boolean bPicFolderInstalled = true;
            	try {
            		getPackageManager().getPackageInfo("com.alensw.PicFolder", 0);
            	} catch (android.content.pm.PackageManager.NameNotFoundException e){
            		bPicFolderInstalled = false;
            		Log.e(LOG_TAG,"com.alensw.PicFolder not installed");
            	}
                try {
                	if(bPicFolderInstalled) {
                		startActivity(new Intent().setClassName("com.alensw.PicFolder","com.alensw.PicFolder.GalleryActivity").addFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TOP));                   
                	}
                	else
                	{
