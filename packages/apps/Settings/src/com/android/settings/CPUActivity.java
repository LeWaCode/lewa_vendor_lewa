...
public class CPUActivity extends PreferenceActivity implements
    ...
    //added by george,2011-10-27,just a ugly patch
    public static final String FREQ_LIST_FILE_PATCH = "/system/misc/cpuinfo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //added by george,2011-10-27
        if (availableFrequenciesLine == null) {
             availableFrequenciesLine = readOneLine(FREQ_LIST_FILE_PATCH);
        }
        if (availableFrequenciesLine != null)
