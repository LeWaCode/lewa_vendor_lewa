...
public class PowerUsageSummary extends PreferenceActivity implements Runnable {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // Begin, Modified by zhumeiquan for better view, 20120331
        setContentView(R.layout.power_usage_layout);
        mDurationView = (TextView)findViewById(R.id.battery_duration);
        // End
    ...
    private void refreshStats() {
        ...
        String durationString = Utils.formatElapsedTime(this, uSecTime / 1000);
        String durationStr = getString(R.string.battery_stats_on_battery, durationString);
        mDurationView.setText(durationStr);
