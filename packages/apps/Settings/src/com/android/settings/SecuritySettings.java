...
public class SecuritySettings extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    private boolean isUploadDebugLogAllowed() {
        return Settings.Secure.getInt(getContentResolver(),
                                      Settings.Secure.LEWA_UPLOAD_DEBUG_LOG, 1) > 0;
    }

    private void setUploadDebugLogAllowed(boolean enabled) {
        // Change the system setting
        Settings.Secure.putInt(getContentResolver(), Settings.Secure.LEWA_UPLOAD_DEBUG_LOG,
                                enabled ? 1 : 0);
    }
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        PreferenceCategory userExperience  = new PreferenceCategory(this);
        userExperience.setTitle(R.string.debug_log);
        root.addPreference(userExperience);
        mCredentialStorage.createPreferences(userExperience, CredentialStorage.TYPE_UE);
        return root;
    }
    ...
    private class CredentialStorage implements DialogInterface.OnClickListener,
        ...
        private static final int TYPE_UE = 2;
        ...
        private CheckBoxPreference mUECheckBox;
        ...
        public boolean onPreferenceClick(Preference preference) {
            if (preference == mInstallButton) {
                ...
                showResetDialog();
            } else if(preference == mUECheckBox){
                setUploadDebugLogAllowed(mUECheckBox.isChecked());
            } else {
                return false;
            }
            return true;
        ...
        private void createPreferences(PreferenceCategory category, int type) {
            ...
            case TYPE_ENCRYPTEDFS:
                ...
                break;
            case TYPE_UE:
                mUECheckBox = new CheckBoxPreference(SecuritySettings.this);
                mUECheckBox.setTitle(R.string.upload_debug_log_title);
                mUECheckBox.setSummary(R.string.upload_debug_log_summary);
                mUECheckBox.setOnPreferenceClickListener(this);
                mUECheckBox.setChecked(isUploadDebugLogAllowed());
                category.addPreference(mUECheckBox);
                break;
            }
        }
