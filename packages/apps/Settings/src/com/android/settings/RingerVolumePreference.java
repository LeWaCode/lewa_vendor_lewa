...
public class RingerVolumePreference extends VolumePreference implements
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked) {
            ...
            //liuhao fix 8269 set notofication volume with work around, first reset notofication volume, then set volume
            //audio set is asynchronous
           int stream_ring = audioManager.getStreamVolume(AudioManager.STREAM_RING);
	   audioManager.setStreamVolume(AudioManager.STREAM_NOTIFICATION, 0, 0);
            ...
            if (mSeekBarVolumizer[0] != null) {
                mSeekBarVolumizer[0].getSeekBar().setProgress(stream_ring);
            }
