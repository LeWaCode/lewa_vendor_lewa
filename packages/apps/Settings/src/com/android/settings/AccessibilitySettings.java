...
public class AccessibilitySettings extends PreferenceActivity {
    ...
    private final String KEY_INPUT_MAGNIFIER =
        "input_magnifier";

    private final String PERSIST_INPUT_MAGNIFIER =
        "persist.sys.magnifier";
    ...
    private CheckBoxPreference mInputMagnifier;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mInputMagnifier = (CheckBoxPreference) findPreference(
            KEY_INPUT_MAGNIFIER);
    ...
    protected void onResume() {
        super.onResume();
        mInputMagnifier.setChecked(SystemProperties.getBoolean(PERSIST_INPUT_MAGNIFIER, false));
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (KEY_INPUT_MAGNIFIER.equals(key)) {
            boolean isChecked = ((CheckBoxPreference) preference).isChecked();
            SystemProperties.set(PERSIST_INPUT_MAGNIFIER, isChecked ? "1" : "0");
