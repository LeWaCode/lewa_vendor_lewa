...
public class LocalePicker extends PreferenceActivity {
    ...
    void createPreferenceScreen() {
        ...
        int i = 0;
        do {
            int j = mLocales.length;            
            if (i < j) {
                Preference pref = new Preference(this, null);
                pref.setTitle(mLocales[i].toString());
                ...
                if (finalSize == 0) {
                    ...
                    if (preprocess[finalSize-1].locale.getLanguage().equals(
                        ...
                        if (s.equals("zz_ZZ")) {
                            ...
                            // Begin, Modified by zhumeiquan for bug ROM #1802
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {    
        int position = Integer.parseInt(preference.getKey());
        try {
