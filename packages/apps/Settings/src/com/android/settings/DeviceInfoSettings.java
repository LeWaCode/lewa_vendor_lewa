...
public class DeviceInfoSettings extends PreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        // by Even, 2012-07-23, added stable version string or develop version string
        int lewaVersionType = SystemProperties.getInt("ro.lewa.version.type", 0);
        setStringSummary("build_number", Build.DISPLAY + getLewaVersionDes(lewaVersionType));
        findPreference("kernel_version").setSummary(getFormattedKernelVersion());
        // by george,2011-11-03,remove mod_version
        /*
    ...
    // by Even, 2012-07-23, added function get lewa version description
    private String getLewaVersionDes(int versionType) {
        String desString = "";
        switch (versionType) {
        case 0:
            desString = getString(R.string.dev_version);
            break;
        case 1:
            desString = getString(R.string.stable_version);
            break;
        default:
            break;
        }
    ...
    private String getFormattedKernelVersion() {
        ...
        try {
            ...
            if (!m.matches()) {
                ...
                //fixed kernel author,by george,2011-11-03
                /*
                return (new StringBuilder(m.group(1)).append("\n").append(
                        "lewa@lewatek").append(" ").append(m.group(3)).append("\n")
                        .append(m.group(4))).toString();
                */
            }
        } catch (IOException e) {
