...
public class AirplaneModeEnabler implements Preference.OnPreferenceChangeListener {
    ...
    public void resume() {
        ...
        Log.e("Tt","resume AirplaneModeEnabler----------isAirplaneModeOn(mContext) = " + isAirplaneModeOn(mContext));
        mCheckBoxPref.setChecked(isAirplaneModeOn(mContext));
		Log.e("Tt","resume AirplaneModeEnabler----------mCheckBoxPref.isChecked() = " + mCheckBoxPref.isChecked());
	...
	Log.e("Tt","isAirplaneModeOn----------Settings.System.getInt(context.getContentResolver(),Settings.System.AIRPLANE_MODE_ON, 0) = " + Settings.System.getInt(context.getContentResolver(),Settings.System.AIRPLANE_MODE_ON, 0));
        return Settings.System.getInt(context.getContentResolver(),Settings.System.AIRPLANE_MODE_ON, 0) != 0;
    }

    private void setAirplaneModeOn(boolean enabling) {
		Log.e("Tt","setAirplaneModeOn----------enabling = " + enabling);
    ...
    private void onAirplaneModeChanged() {
		...
		Log.e("Tt","onAirplaneModeChanged----------airplaneModeEnabled = " + airplaneModeEnabled);
