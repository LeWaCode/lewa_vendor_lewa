...
public class LewaWirelessSettings extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.lewa_wireless_settings);

        CheckBoxPreference airplane = (CheckBoxPreference) findPreference(KEY_TOGGLE_AIRPLANE);
        // Begin, Deleted by zhumeiquan, 20111109
        /*
    ...
    */
    ...
    // Begin, added by zhumeiquan for Viewpager, 20111107
    @Override
