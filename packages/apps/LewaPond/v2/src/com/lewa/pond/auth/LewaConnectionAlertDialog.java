...
public class LewaConnectionAlertDialog implements DialogInterface.OnClickListener, OnCancelListener {
	...
	public LewaConnectionAlertDialog(Context context) {
...
//		boolean c = this.connected();
	...
	public void showAlertDialog(final Class<?> goClass) {
		AlertDialog.Builder adb = new AlertDialog.Builder(this.context);
		adb.setTitle(this.title);
		adb.setMessage(this.message);
		adb.setPositiveButton(this.context.getString(R.string.label_ok), new DialogInterface.OnClickListener() {
