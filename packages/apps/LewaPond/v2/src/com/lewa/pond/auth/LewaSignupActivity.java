...
public class LewaSignupActivity extends Activity implements OnCancelListener, OnDismissListener, AlertDialogListener {
	...
	protected void openRegPage() {
		...
		//Log.d(TAG,"url==="+url);http://api.lewatek.com/account/signup/
		...
		//Log.d(TAG,"url=="+url);http://api.lewatek.com/account/signup/?lang=zh_CN&density_dpi=240dpi&initial_scale=1.5
		webView.loadUrl(url);
	}
