...
public class BootAnimation extends OnlineSlideBase{
    ...
    protected ArrayList<String> getList() {
        ...
        list.add(new StringBuilder().append(ThemeConstants.THEME_ONLINE_PREVIEW).append("/").append(name).append("/preview_bootanimation_0.jpg").toString());
        return list;
    }
