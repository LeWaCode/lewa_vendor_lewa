...
public class Phone extends SlideBaseActivity {
	...
	protected ArrayList<String> getList() {
		...
		File[] files = preview.listFiles(new ThemeFileFilter(
				ThemeConstants.PREVIEW_PHONE, ThemeFileFilter.INDEXOF));
	...
	private class ApplyTask extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPreExecute() {
			...
			progressDialog.setTitle(R.string.setting_phone_title);
			progressDialog.setMessage(mContext
					.getString(R.string.setting_phone_msg));
			progressDialog.show();
		}
		...
		protected Boolean doInBackground(String... params) {
			...
			boolean result = applyModule(
					...
					ThemeConstants.THEME_FACE_PHONE_TEMP,
					ThemeConstants.THEME_FACE_PHONE);
			if (!ThemeUtil.modulesOnApplied
					.contains(ThemeConstants.THEME_MODEL_PHONE)) {
				ThemeUtil.modulesOnApplied.add(ThemeConstants.THEME_MODEL_PHONE);
			}
//			if (!ThemeUtil.modulesOnApplied.contains("android")) {
//				ms.add(ThemeConstants.THEME_MODEL_FRAMEWORK);
//				applyModule(ThemeConstants.THEME_MODEL_FRAMEWORK_STYLE,
//						ThemeConstants.THEME_MODEL_FRAMEWORK,
//						ThemeConstants.THEME_FACE_FRAMEWORK_TEMP,
//						ThemeConstants.THEME_FACE_FRAMEWORK);
//			}
	...
	return result;
		...
		protected void onPostExecute(Boolean result) {
			...
			if (result) {
				...
				editor.putString("phone", themeBase.getPkg()).commit();
