...
import com.lewa.face.loadimage.FileCategoryHelper.FileCategory;
import com.lewa.face.loadimage.FileIconLoader.IconLoadFinishListener;
...
//        }, R.drawable.file_icon_rar);
    ...
    public void setIcon(ThumbnailBase fileInfo, ImageView fileImage, ImageView fileImageFrame,int picDefult,int videoDefault,int underlyDefault) {
