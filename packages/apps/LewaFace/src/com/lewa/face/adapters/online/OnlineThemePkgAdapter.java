...
public class OnlineThemePkgAdapter extends ThumbnailOnlineAdapter{
    ...
    private static final String TAG = OnlineThemePkgAdapter.class.getSimpleName();
    
    public OnlineThemePkgAdapter(Context context,ArrayList<ThemeBase> themeBases,int themeType){
