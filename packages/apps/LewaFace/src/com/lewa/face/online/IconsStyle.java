...
import com.lewa.face.adapters.online.OnlineIconsStyleAdapter;
 ...
 *
 */
public class IconsStyle extends OnlineBaseActivity{
    ...
    protected Object initUrl() {
    	...
    	return UrlParam.newUrlParam(UrlParam.ICONSTYLE);
    }
    ...
    protected ThumbnailOnlineAdapter onlineAdapterInstance() {
        ...
        return new OnlineIconsStyleAdapter(mContext, themeBases, ThemeConstants.THEME_ONLINE);
    }
