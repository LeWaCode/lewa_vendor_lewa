...
import com.lewa.face.adapters.online.OnlineLockScreenStyleAdapter;
 ...
 *
 */
public class LockScreenStyle extends OnlineBaseActivity{
    ...
    protected Object initUrl() {
        ...
        return UrlParam.newUrlParam(UrlParam.LOCKSCREEN);
    }
    ...
    protected ThumbnailOnlineAdapter onlineAdapterInstance() {
        ...
        return new OnlineLockScreenStyleAdapter(mContext, themeBases, ThemeConstants.THEME_ONLINE);
    }
}
