...
import com.lewa.face.adapters.online.OnlineBootsAdapter;
 ...
 *
 */
public class BootAnimation extends OnlineBaseActivity{
    ...
    protected Object initUrl() {
    	...
    	return UrlParam.newUrlParam(NetBaseParam.BOOTANIMATION);
//        return ThemeUtil.BOOTS_INFO_URL;
    }
    ...
    protected ThumbnailOnlineAdapter onlineAdapterInstance() {
        ...
        return new OnlineBootsAdapter(mContext, themeBases, ThemeConstants.THEME_ONLINE);
    }
