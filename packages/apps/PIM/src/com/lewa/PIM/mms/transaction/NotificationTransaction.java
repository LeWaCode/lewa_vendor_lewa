...
import static com.lewa.PIM.mms.transaction.TransactionState.FAILED;
import static com.lewa.PIM.mms.transaction.TransactionState.INITIALIZED;
import static com.lewa.PIM.mms.transaction.TransactionState.SUCCESS;
...
public class NotificationTransaction extends Transaction implements Runnable {
    ...
    public void run() {
        ...
        boolean dataSuspended = (PimApp.getApplication().getTelephonyManager().getDataState() ==
