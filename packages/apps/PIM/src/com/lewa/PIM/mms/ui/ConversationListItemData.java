...
public class ConversationListItemData {
    ...
    public ConversationListItemData(Context context, Conversation conv) {
        ...
        mDate = MessageUtils.formatTimeStamp(context, conv.getDate(),false);
        ...
        mImslUser = conv.hasImsUser();
        mImsDataType = conv.getImsDataType();
        mImsState = conv.getImsState();
        updateRecipients();
    }
