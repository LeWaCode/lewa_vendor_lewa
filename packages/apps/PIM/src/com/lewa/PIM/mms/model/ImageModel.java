...
public class ImageModel extends RegionMediaModel {
    ...
    private void initModelFromUri(Uri uri) throws MmsException {
        ...
        mSrc = getCurrentTimestamp() + "_" + uriImage.getSrc();
