...
import com.lewa.PIM.mms.ArrayListCursor;
...
public class RecipientsAdapter extends ResourceCursorAdapter {
    ...
    public RecipientsAdapter(Context context) {
        ...
        mEmailAddrCompletion = prefs.getBoolean(MessagingPreferenceActivity.EMAIL_ADDR_COMPLETION, true);
    }
    ...
    public void setListView(FrameLayout list){
    	mListView = list;
    }
