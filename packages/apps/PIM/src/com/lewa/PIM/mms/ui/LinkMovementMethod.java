...
extends ScrollingMovementMethod
{
        ...
        if (action == MotionEvent.ACTION_UP ||
            ...
            if (link.length != 0) {
                if (action == MotionEvent.ACTION_UP) {
                    ...
                    String string = span.getURL(); 
                    mIsClick = true;
                    if (string.indexOf("mailto:", 0) >= 0){
                        Uri uir = Uri.parse(string);
    ...
    public static void setIsOnClick(boolean b){
    	mIsClick = b;
    }
    
    public static boolean getIsOnClick(){
    	return mIsClick;
    }
}
