...
public class SpecialCharSequenceMgr {
    ...
    static boolean handleSecretCode(Context context, String input) {
        ...
        if (len > 8 && input.startsWith("*#*#") && input.endsWith("#*#*")) {
            Intent intent = new Intent("android.provider.Telephony.SECRET_CODE", //Intents.SECRET_CODE_ACTION,
...
//            }
            ...
            try {
                ...
                if (null != objITelephony)
                {
                    ...
                    Method methodhandlePinMmi = clsITelephony.getDeclaredMethod("handlePinMmi", paramTypes);
                    Object[] parameters = new Object[] {input};
                    methodhandlePinMmi.setAccessible(true);
                    return (Boolean )methodhandlePinMmi.invoke(objITelephony, parameters);
                }
            }
            catch (Exception e) {
                e.printStackTrace();
    ...
    private static class QueryHandler extends AsyncQueryHandler {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor c) {
            ...
            if ((c != null) && (text != null) && (c.moveToPosition(sc.contactNum))) {
                ...
                //Deleted by GanFeng 20120203, fix bug2206
