 ...
 */
public class ContactOptionsActivity extends PreferenceActivity implements OnPreferenceChangeListener{

    private static final String TAG = "ContactOptionsActivity";
    private static final String PRE_RING_TONE = "pref_key_ringtone_contacts";
    private static final String PRE_RING_SEND_TO_VOICEMAIL = "pref_key_send_to_voicemail";
    ...
    private CheckBoxPreference mSendToVoicemailCheckPre;
...
//        mSendToVoicemailCheckbox = (CheckBox)sendToVoicemailLayout.findViewById(R.id.checkbox);
        ...
        addPreferencesFromResource(R.xml.contact_options);
        
        mRingtonePreference = (RingtonePreference)findPreference(PRE_RING_TONE);
        ((Preference)mRingtonePreference).setOnPreferenceChangeListener(this);
        
        
        mSendToVoicemailCheckPre = (CheckBoxPreference)findPreference(PRE_RING_SEND_TO_VOICEMAIL);
        mSendToVoicemailCheckPre.setOnPreferenceChangeListener(this);
    }
...
//        mSendToVoicemailCheckbox.setChecked(mSendToVoicemail);
        ...
        Ringtone ringtone = RingtoneManager.getRingtone(this, ringtoneUri);
        if (ringtone != null) {
            mRingtonePreference.setSummary(ringtone.getTitle(this));
            SharedPreferences.Editor editor = mePrefs.edit();
            editor.putString(PRE_RING_TONE, ringtoneUri.toString());
            editor.commit();
        }
        mSendToVoicemailCheckPre.setChecked(mSendToVoicemail);
    }
...
//    }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mRingtonePreference) {
            mCustomRingtone = (String)newValue;
            saveData();
        } else if (preference == mSendToVoicemailCheckPre) {
            mSendToVoicemail = (Boolean)newValue;
            saveData();
        }
        return true;
    }
