...
public class DialtactsActivity extends TabActivity implements TabHost.OnTabChangeListener {
    ...
    private void setupCallLogTab() {
        ...
        Intent intent = new Intent("com.lewa.intent.action.CALLLOG");
    ...
    private void setupDialerTab(Intent dialIntent) {
        //Intent intent = new Intent("com.android.phone.action.TOUCH_DIALER");
        //intent.setClass(this, TwelveKeyDialer.class);
        Intent intent = new Intent("com.lewa.intent.action.DIALPAD", dialIntent.getData());
