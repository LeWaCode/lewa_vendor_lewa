...
public abstract class BaseContactEditorView extends LinearLayout {
    ...
    protected StickerPhotoEditorView mStickerPhoto;
    protected View mStickerPhotoDivider;
     ...
     * for the {@link EntityDelta} currently being edited.
     */
    public void setStickerPhotoBitmap(Bitmap bitmap) {
        mStickerPhoto.setPhotoBitmap(bitmap);
    }
    /**
    ...
    public StickerPhotoEditorView getStickerPhotoEditor() {
        return mStickerPhoto;
    }
    public View getStickerPhotoDivider() {
        return mStickerPhotoDivider;
    }
    /**
