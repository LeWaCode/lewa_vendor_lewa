...
import com.lewa.PIM.contacts.model.ContactsSource.EditField;
...
public class EntityModifier {
    ...
    public static void ensureKindExists(EntityDelta state, ContactsSource source, String mimeType) {
        ...
        if (!hasChild && kind != null) {
            ...
            if (kind.mimeType.equals(Photo.CONTENT_ITEM_TYPE) || kind.mimeType.equals(DisplayPhoto.CONTENT_ITEM_TYPE)) {
