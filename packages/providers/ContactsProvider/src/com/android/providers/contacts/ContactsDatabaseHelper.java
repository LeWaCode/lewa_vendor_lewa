...
/* package */ class ContactsDatabaseHelper extends SQLiteOpenHelper {
     ...
     * </pre>
     */
    static final int DATABASE_VERSION = 357;
    ...
    public interface Tables {
	 ...
	 public static final String PHOTO_FILES = "photo_files";
        ...
        public static final String ROSTER_DATA = "roster_data";
        //end
    ...
    public interface ContactsColumns {
        ...
        public static final String CONCRETE_LOOKUP_KEY = Tables.CONTACTS + "."
                + Contacts.LOOKUP_KEY;
        public static final String CONCRETE_CONTACT_TYPE = Tables.CONTACTS + "."
                + Contacts.CONTACT_TYPE;
        public static final String CONCRETE_YI_REMARK = Tables.CONTACTS+ "."
                + Contacts.YL_REMARK;
    }
    ...
    public interface RawContactsColumns {
        ...
        public static final String CONCRETE_CONTACT_TYPE = Tables.RAW_CONTACTS+ "."
                + RawContacts.CONTACT_TYPE;
        public static final String CONCRETE_YI_REMARK = Tables.RAW_CONTACTS+ "."
                + RawContacts.YL_REMARK;
        public static final String CONCRETE_YI_STATUS = Tables.RAW_CONTACTS+ "."
                + RawContacts.YL_STATUS;
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Tables.CONTACTS + " (" +
                ...
                Contacts.CONTACT_TYPE + " INTEGER NOT NULL DEFAULT 0," +
                Contacts.YL_REMARK + " TEXT" +
        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.RAW_CONTACTS + " (" +
                ...
                RawContacts.CONTACT_TYPE + " INTEGER NOT NULL DEFAULT 0," +
                RawContacts.YL_REMARK + " TEXT, " +
                RawContacts.YL_STATUS + " INTEGER NOT NULL DEFAULT 0, " +
...
//        ");");
        ...
        db.execSQL("CREATE TABLE " + Tables.USER + "(" +
                ...
                User.REMARK + " TEXT," +
                User.EMAIL + " TEXT," +
                User.WEIBO_NAME + " TEXT," +
                User.WEIBO_STATUS + " INTEGER NOT NULL DEFAULT 0," +
                User.STATUS + " INTEGER NOT NULL DEFAULT 0," +
                User.ACCOUNT_TYPE + " INTEGER NOT NULL DEFAULT 0" +
                ");");
        
        db.execSQL("CREATE TABLE " + Tables.ROSTER + "(" +
                BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                Roster.CONTACT_ID + " INTEGER NOT NULL DEFAULT 0," +
                Roster.NAME_USER_ID + " INTEGER NOT NULL DEFAULT 0," +                
                Roster.DISPLAY_NAME + " TEXT," +
                Roster.SORT_KEY + " TEXT," +
//                Roster.SORT_KEY_ALT + " TEXT," +
                Roster.DURATION + " INTEGER," +
                Roster.REMARK + " TEXT," +
                Roster.PHOTO + " TEXT," +
                Roster.IS_DEFAULT + " INTEGER NOT NULL DEFAULT 0," +
                Roster.STATUS + " INTEGER NOT NULL DEFAULT 0" +
//                Roster.IS_LOCAL + " INTEGER NOT NULL DEFAULT 0" +
                ");");
        db.execSQL("CREATE INDEX IF NOT EXISTS roster_contact_id_index on roster(contact_id)");
        
        db.execSQL("CREATE TABLE " + Tables.ROSTER_DATA + "(" +
                BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT," +
                RosterData.ROSTER_ID + " INTEGER," + 
                RosterData.ROSTER_USER_ID + " TEXT," + 
                RosterData.NAME_USER_ID + " INTEGER," +
                RosterData.NICK_NAME + " TEXT," +
                RosterData.DISPLAY_NAME + " TEXT," +
                RosterData.EMAIL + " TEXT," +
                RosterData.PHOTO + " TEXT," +
                RosterData.SORT_KEY + " TEXT," +
//                RosterData.SORT_KEY_ALT + " TEXT," +
                RosterData.DURATION + " INTEGER," +
                RosterData.REMARK + " TEXT," +
                RosterData.STATUS + " INTEGER NOT NULL DEFAULT 0," +
                RosterData.IS_PRIMARY + " INTEGER" +
                ");");
        db.execSQL("CREATE INDEX IF NOT EXISTS roster_data_roster_id_index on roster_data(roster_id)");
        db.execSQL("CREATE INDEX IF NOT EXISTS roster_data_user_id_index on roster_data(roster_user_id)");
        //end jxli

	 //add for high-res photo by shenqi
    ...
    private static void createContactsTriggers(SQLiteDatabase db) {
        ...
        //for yiliao, add by jxli
        db.execSQL("DROP TRIGGER IF EXISTS " + Tables.USER + "_delete;");
        db.execSQL("CREATE TRIGGER " + Tables.USER + "_delete"
                + "   BEFORE DELETE ON " + Tables.USER
                + " BEGIN "
                + "   DELETE FROM " + Tables.ROSTER
                + "     WHERE " + Roster.NAME_USER_ID + "=OLD." + User._ID + ";"
                + "   DELETE FROM " + Tables.ROSTER_DATA
                + "     WHERE " + RosterData.NAME_USER_ID + "=OLD." + User._ID + ";"
                + " END");

	 db.execSQL("DROP TRIGGER IF EXISTS " + Tables.ROSTER_DATA + "_update;");
        db.execSQL("CREATE TRIGGER " + Tables.ROSTER_DATA + "_update"
                + "   AFTER UPDATE ON " + Tables.ROSTER_DATA
                + " BEGIN "
                + "   UPDATE " + Tables.ROSTER
                + "     SET "
                +         Roster.DURATION + "=NEW." + RosterData.DURATION
                + "     WHERE " + Roster._ID + "=NEW." + RosterData.ROSTER_ID + ";"
                + " END");
/*
        db.execSQL("CREATE TRIGGER " + Tables.CONTACTS + "_delete"
                + "   BEFORE DELETE ON " + Tables.CONTACTS
                + " BEGIN "
                + "   UPDATE " + Tables.ROSTER
                + "     SET "
                +         Roster.CONTACT_ID + "=0"
                + "     WHERE " + Roster.CONTACT_ID + "=OLD." + BaseColumns._ID + ";"
                + " END");*/
        //end
    }
    ...
    private static void createContactsViews(SQLiteDatabase db) {
        ...
        String contactsColumns =
                ...
                + Contacts.PHOTO_ID + ", "
                + Contacts.PHOTO_FILE_ID + ", "
                + "name_raw_contact." + Contacts.CONTACT_TYPE
                        + " AS " + Contacts.CONTACT_TYPE + ", "
                + "name_raw_contact." + Contacts.YL_REMARK
                + " AS " + Contacts.YL_REMARK + ", "
//                + Contacts.SIM + ", "
                + ContactsColumns.CONCRETE_LAST_TIME_CONTACTED
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
	 ...
	 if (oldVersion == 355) {
            upgradeViewsAndTriggers = true;
            upgradeToVersion356(db);
            oldVersion = 356;
        }
	 if (oldVersion == 356) {
         upgradeViewsAndTriggers = true;
         upgradeToVersion357(db);
         oldVersion = 357;
     }  
    ...
    private void upgradeToVersion354(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + Tables.CONTACTS
                + " ADD " + Contacts.CONTACT_TYPE + " INTEGER NOT NULL DEFAULT 0;");
        db.execSQL("ALTER TABLE " + Tables.CONTACTS
                + " ADD " + Contacts.YL_REMARK + " TEXT;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + RawContacts.CONTACT_TYPE + " INTEGER NOT NULL DEFAULT 0;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + RawContacts.YL_REMARK + " TEXT;");
...
//                Roster.SORT_KEY_ALT + " TEXT," +
                ...
                Roster.REMARK + " TEXT," +
                Roster.PHOTO + " TEXT," +
                Roster.IS_DEFAULT + " INTEGER NOT NULL DEFAULT 1," +
                Roster.STATUS + " INTEGER NOT NULL DEFAULT 0" +
//                Roster.IS_LOCAL + " INTEGER NOT NULL DEFAULT 0" +
                ");");
        db.execSQL("CREATE INDEX IF NOT EXISTS roster_contact_id_index on roster(contact_id)");
...
//                RosterData.SORT_KEY_ALT + " TEXT," +
    ...
    private void upgradeToVersion355(SQLiteDatabase db) {
            db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + RawContacts.YL_STATUS + " INTEGER NOT NULL DEFAULT 0;");
            db.execSQL("ALTER TABLE " + Tables.ROSTER_DATA
                + " ADD " + RosterData.STATUS + " INTEGER NOT NULL DEFAULT 0;");
    }

     private void upgradeToVersion356(SQLiteDatabase db) {
    ...
    private void upgradeToVersion357(SQLiteDatabase db){
    	db.execSQL("ALTER TABLE " + Tables.USER + " ADD " + User.WEIBO_NAME + " TEXT;");
    	 db.execSQL("ALTER TABLE " + Tables.USER
                 + " ADD " + User.WEIBO_STATUS + " INTEGER NOT NULL DEFAULT 0;");
    }
    //add end
