...
public class SmsProvider extends ContentProvider {
    ...
    private SmsDataItem mSmsDataItem;
    ...
    private ArrayList<String> convertIccToSms(SmsMessage message) {
        ...
        int type = message.getStatusOnIcc();
        Log.e(TAG, "convertIccToSms() type = "  + type);
        if (type == SmsManager.STATUS_ON_ICC_READ || type == SmsManager.STATUS_ON_ICC_UNREAD){
            result.add(TextBasedSmsColumns.MESSAGE_TYPE_INBOX);    
        }else{
            result.add(TextBasedSmsColumns.MESSAGE_TYPE_SENT);
        }        
        //zhangwei add
        result.add(0);      // locked
    ...
    public Uri insert(Uri url, ContentValues initialValues) {
        ...
        //Begin Delete by chenqiang,20121015
//        if (table == TABLE_SMS &&  
//            type == Sms.MESSAGE_TYPE_INBOX){            
//            
//            String tbody = values.getAsString(Sms.BODY);            
//            Long tTime = values.getAsLong(Sms.DATE);
//            String taddress = values.getAsString(Sms.ADDRESS);
//            if (mSmsDataItem.address.equals(taddress) &&
//                mSmsDataItem.body.equals(tbody) &&
//                mSmsDataItem.date > 0){
//                
//                Long afterTime = (tTime - mSmsDataItem.date) / 1000;
//                
//                Log.d(TAG, "tbody =  " + tbody);
//                Log.d(TAG, "taddress =  " + taddress);                
//                Log.d(TAG, "afterTime =  " + afterTime);
//                
//                mSmsDataItem.date = tTime;
//                
//                if (afterTime <= 1 && afterTime >= -1){
//                    return null;
//                }
//            }
//            mSmsDataItem.address = taddress;
//            mSmsDataItem.body = tbody;
//            mSmsDataItem.date = tTime;
//        }
        //Delete end.
